...
import fridge_app.views as fridge_views
...
class TestUrls(SimpleTestCase):
    ...
    def test_expired_url_resolves(self):
        url = reverse('item-expired')
        self.assertEqual(resolve(url).func, fridge_views.expired)

    def test_sorted_resolves(self):
        url = reverse('item-sorted')
        self.assertEqual(resolve(url).func, fridge_views.sort_category)
